...
(function (global) {
  ...
  class SimpleChart {
    ...
    _ensureSize() {
      ...
      if (this.canvas.width !== Math.floor(displayWidth * ratio)) {
        this.canvas.width = Math.floor(displayWidth * ratio);
      }
      if (this.canvas.height !== Math.floor(displayHeight * ratio)) {
