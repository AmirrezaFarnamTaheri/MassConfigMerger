...
- `MERGE_INTERVAL` – seconds between each run of `massconfigmerger merge` (default `86400`)
- `AGGREGATE_INTERVAL` – seconds between `massconfigmerger full` runs when the `aggregator` profile is enabled (default `43200`)
